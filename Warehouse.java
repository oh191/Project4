...
public class Warehouse {
    ...
    public static void printStatisticsReport(double profits, int packagesShipped, int numberOfPackages) {
        String forProfits = String.format("%26s",
                NumberFormat.getCurrencyInstance(new
                        Locale("en", "US")).format(profits));
    ...
    public static void main(String[] args) {
            ...
            switch (option) {
                case 1:
                    try {
                        ...
                        ShippingAddress shippingAddress = new ShippingAddress(buyerName,
                                buyerAddress, buyerCity, buyerState, buyerZIPCode);
        ...
        //3) save data (vehicle, packages, profits
        //packages shipped and primeday) to files (overwriting them) 
